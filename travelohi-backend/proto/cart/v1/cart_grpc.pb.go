...
const (
	CartService_AddToCart_FullMethodName           = "/travelohi.v1.cart.CartService/AddToCart"
	CartService_ViewCart_FullMethodName            = "/travelohi.v1.cart.CartService/ViewCart"
	CartService_UpdateCartItem_FullMethodName      = "/travelohi.v1.cart.CartService/UpdateCartItem"
	CartService_RemoveFromCart_FullMethodName      = "/travelohi.v1.cart.CartService/RemoveFromCart"
	CartService_ApplyPromo_FullMethodName          = "/travelohi.v1.cart.CartService/ApplyPromo"
	CartService_Checkout_FullMethodName            = "/travelohi.v1.cart.CartService/Checkout"
	CartService_InternalCreatePromo_FullMethodName = "/travelohi.v1.cart.CartService/InternalCreatePromo"
)
...
type CartServiceClient interface {
	...
	// Checkout & Promos
	ApplyPromo(ctx context.Context, in *ApplyPromoRequest, opts ...grpc.CallOption) (*ViewCartResponse, error)
	Checkout(ctx context.Context, in *CheckoutRequest, opts ...grpc.CallOption) (*CheckoutResponse, error)
	// Internal Administration
	InternalCreatePromo(ctx context.Context, in *InternalCreatePromoRequest, opts ...grpc.CallOption) (*InternalCreatePromoResponse, error)
}
...
func (c *cartServiceClient) ApplyPromo(ctx context.Context, in *ApplyPromoRequest, opts ...grpc.CallOption) (*ViewCartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ViewCartResponse)
	err := c.cc.Invoke(ctx, CartService_ApplyPromo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cartServiceClient) InternalCreatePromo(ctx context.Context, in *InternalCreatePromoRequest, opts ...grpc.CallOption) (*InternalCreatePromoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InternalCreatePromoResponse)
	err := c.cc.Invoke(ctx, CartService_InternalCreatePromo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServiceServer interface {
	...
	// Checkout & Promos
	ApplyPromo(context.Context, *ApplyPromoRequest) (*ViewCartResponse, error)
	Checkout(context.Context, *CheckoutRequest) (*CheckoutResponse, error)
	// Internal Administration
	InternalCreatePromo(context.Context, *InternalCreatePromoRequest) (*InternalCreatePromoResponse, error)
...
func (UnimplementedCartServiceServer) ViewCart(context.Context, *ViewCartRequest) (*ViewCartResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ViewCart not implemented")
}
func (UnimplementedCartServiceServer) UpdateCartItem(context.Context, *UpdateCartItemRequest) (*CartResponse, error) {
...
func (UnimplementedCartServiceServer) ApplyPromo(context.Context, *ApplyPromoRequest) (*ViewCartResponse, error) {
...
func (UnimplementedCartServiceServer) InternalCreatePromo(context.Context, *InternalCreatePromoRequest) (*InternalCreatePromoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InternalCreatePromo not implemented")
}
...
func _CartService_ApplyPromo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyPromoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).ApplyPromo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_ApplyPromo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).ApplyPromo(ctx, req.(*ApplyPromoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CartService_InternalCreatePromo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InternalCreatePromoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).InternalCreatePromo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_InternalCreatePromo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).InternalCreatePromo(ctx, req.(*InternalCreatePromoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "travelohi.v1.cart.CartService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CartService_ApplyPromo_Handler,
		},
		{
			MethodName: "Checkout",
		...
		{
			MethodName: "InternalCreatePromo",
			Handler:    _CartService_InternalCreatePromo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/travelohi/v1/cart/cart.proto",
}
