...
func (c *authServiceClient) LoginWithOTP(ctx context.Context, in *LoginWithOTPRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
func (c *authServiceClient) GetSecurityQuestion(ctx context.Context, in *GetSecurityQuestionRequest, opts ...grpc.CallOption) (*GetSecurityQuestionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSecurityQuestionResponse)
	err := c.cc.Invoke(ctx, AuthService_GetSecurityQuestion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) LoginWithOTP(context.Context, *LoginWithOTPRequest) (*AuthResponse, error) {
...
func (UnimplementedAuthServiceServer) GetSecurityQuestion(context.Context, *GetSecurityQuestionRequest) (*GetSecurityQuestionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSecurityQuestion not implemented")
}
...
func _AuthService_GetSecurityQuestion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSecurityQuestionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetSecurityQuestion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetSecurityQuestion_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetSecurityQuestion(ctx, req.(*GetSecurityQuestionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "travelohi.v1.auth.AuthService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_GetSecurityQuestion_Handler,
		},
		{
	...
	Metadata: "proto/travelohi/v1/auth/auth.proto",
}
